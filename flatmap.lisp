...
(defun myMap (f l)
(if (equal nil l) nil (cons(funcall f (car l)) (myMap f (cdr l)))))
...
(write(myFlattenMap (lambda (a) (+ a 2)) (list (list 3 5 7 9)(list 10 15 18 20)))) ;; Should return: (5 7 9 11)
